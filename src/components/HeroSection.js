  ...
  return (
    ...
    >
      <div className="md:w-2/3 lg:w-1/2 container px-5 md:px-16 mx-auto">
        ...
        İnşaat sektöründe yenilikçi ve güvenilir çözümler sunan Oftima olarak, hayallerinizdeki yapıları gerçeğe dönüştürmek için buradayız. 
        Profesyonel ekibimiz ve yıllara dayanan deneyimimizle, projelerinizi zamanında ve bütçenize uygun bir şekilde tamamlıyoruz. 
        Kalite, güven ve müşteri memnuniyeti odaklı yaklaşımımızla hizmetinizdeyiz.
        </p>
      </div>
