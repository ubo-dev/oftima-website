...
export default function AboutUs() {
  return (
    ...
    >
      <div>
        <span className="service-name text-center block text-2xl font-bold">
          HAKKIMIZDA
        </span>
        <h2 className="title text-center text-4xl font-semibold mt-4">
          Neler Yapıyoruz?
        </h2>
        ...
        <div className="text-center mx-auto py-5 text-lg max-w-3xl">
          ...
          sürdürülebilir çözümler sunarak, çevreye duyarlı ve estetik açıdan
          üstün yapılar inşa etmeyi amaçlıyoruz. Misyonumuz, müşteri
          beklentilerini aşarak, her projede yüksek kalite standartlarını
          sağlamaktır. Vizyonumuz ise, sektörde lider ve öncü bir firma
          olmaktır.
        </div>

        <span className="service-name text-center block text-2xl font-bold mt-12">
          DEĞERLERİMİZ
        </span>
        <h2 className="title text-center text-4xl font-semibold mt-4">
